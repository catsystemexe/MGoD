...
export async function createGame(
  ...
  // BG MVP1: ensure a stable level identity for bgBindings (fallback)
  // If your future Level/Scene system sets this, it will override naturally.
  (world as any).levelId ??= (world as any).sceneId ??= "debug";
