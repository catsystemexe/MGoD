...
export class SpawnSystem {
  private dbgEvery = 0; // simple throttling counter
  ...
  constructor(
    ...
    if (!this.cfg.projectile || !this.cfg.bomb) {
      throw new Error(`[SpawnSystem] cfg.projectile and cfg.bomb must be defined`);
    }
  }
